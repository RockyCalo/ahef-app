...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('neuro_meninges', function (Blueprint $table) {
            $table->id();
            $table->string('no_brudzinski')->nullable();
            $table->string('no_kernigs')->nullable();
    ...
    {
        Schema::dropIfExists('neuro_meninges');
    }
};
