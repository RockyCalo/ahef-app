...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('physical_exam_heads', function (Blueprint $table) {
            $table->id();
            $table->string('unremarkable')->nullable();
            $table->string('deformity')->nullable();
            $table->string('alopecia')->nullable();
            $table->string('lesion')->nullable();
            $table->string('mass')->nullable();
            $table->string('others_pe_head')->nullable();
    ...
    {
        Schema::dropIfExists('physical_exam_heads');
    }
};
