...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('physical_exam_chest_lungs', function (Blueprint $table) {
            ...
            $table->string('abnormal_fremitus')->nullable();
            $table->string('retractions')->nullable();
            $table->string('abnormal_breath')->nullable();
            $table->string('others_physical_exam_chest')->nullable();
